...
Usage:
    sh scripts/security_prescan.py --project default --feature my-feature --diff-target main
    sh scripts/security_prescan.py --diff-target main  # Uses active project from config
"""
